...
%% double-blind review; "review" adds line numbers required by KDD
%% reviewers. For the camera-ready, swap in [sigconf,screen] and fill
%% in \acmConference/\copyrightyear/\acmDOI/\acmISBN.
...
% KDD-style review line numbers: black, not red (acmart's [review] default is red).
\AtBeginDocument{%
  \providecommand\BibTeX{{Bib\TeX}}%
  \providecommand\linenumberfont{}%
  \renewcommand\linenumberfont{\normalfont\tiny\sffamily\color{black}}%
}

\begin{document}

\title{Trust-Gated Capability Control: An Operational Framework for Breaking the
