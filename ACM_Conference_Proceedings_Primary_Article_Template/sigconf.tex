...
(Definition~\ref{def:grant}) supplies exactly that policy, and is modality-agnostic
(sensor-fusion calibration for embodied agents; incentive layers via~\cite{instai2026}).
...
An anonymized reviewer repository (full source, E1--E16 harnesses, per-turn logs) is at
